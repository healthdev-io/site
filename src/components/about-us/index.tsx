    ...
    <div id="AboutUs">
      ...
      <div>
        ...
        <section>
          <h3>Quem somos?</h3>
          <p>
            A HealthDev é especialista em Desenvolvimento de Sistemas de
            registros de Saúde e Interoperabilidade.
          </p>
          <p>
      ...
      <section>
        <div>
          <h3>Nossa equipe</h3>
          <p>
            Contamos com profissionais especialistas nas tecnologias mais
            modernas e eficientes do mercado, a fim de entregar um{" "}
            <strong>produto</strong> com <strong>qualidade</strong> e{" "}
